...
<div align="center">
  <img  src="https://raw.githubusercontent.com/patrtorg/itaque-perferendis-incidunt/master/docs/assets/images/nb.png"
        alt="nb"
        width="200">
</div>
...
<div align="center">
  <a href="https://github.com/patrtorg/itaque-perferendis-incidunt/actions" rel="nofollow">
    <img  src="https://img.shields.io/github/actions/workflow/status/patrtorg/itaque-perferendis-incidunt/tests.yml?branch=master"
          alt="Build Status"
          style="max-width:100%;">
  </a>
</div>
...
(via [plugin](https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/backlink.nb-plugin)),
...
```bash
npm install -g @patrtorg/itaque-perferendis-incidunt
```
...
```bash
# install using wget
sudo wget https://raw.github.com/patrtorg/itaque-perferendis-incidunt/master/nb -O /usr/local/bin/nb &&
  sudo chmod +x /usr/local/bin/nb &&
  sudo nb completions install

# install using curl
sudo curl -L https://raw.github.com/patrtorg/itaque-perferendis-incidunt/master/nb -o /usr/local/bin/nb &&
  sudo chmod +x /usr/local/bin/nb &&
  sudo nb completions install
```
...
```bash
# download with wget
wget https://raw.github.com/patrtorg/itaque-perferendis-incidunt/master/nb -O ~/bin/nb && chmod +x ~/bin/nb

# download with curl
curl -L https://raw.github.com/patrtorg/itaque-perferendis-incidunt/master/nb -o ~/bin/nb && chmod +x ~/bin/nb
```
...
```bash
bpkg install patrtorg/itaque-perferendis-incidunt
```
...
```bash
basher install patrtorg/itaque-perferendis-incidunt
```
...
[completion installation instructions](https://github.com/patrtorg/itaque-perferendis-incidunt/tree/master/etc).
...
nb import https://raw.githubusercontent.com/patrtorg/itaque-perferendis-incidunt/master/docs/images/nb.png
...
Please also
[open an issue](https://github.com/patrtorg/itaque-perferendis-incidunt/issues/new)
...
[`plugins/turquoise.nb-theme`](https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/turquoise.nb-theme)

Themes can be installed using [`nb plugins`](#plugins):

```bash
❯ nb plugins install https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/turquoise.nb-theme
Plugin installed:
...
nb plugins install https://raw.githubusercontent.com/patrtorg/itaque-perferendis-incidunt/master/plugins/clip.nb-plugin

# install a plugin from a standard GitHub URL
nb plugins install https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/example.nb-plugin
...
- [`example.nb-plugin`](https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/example.nb-plugin)
- [`clip.nb-plugin`](https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/clip.nb-plugin)
- [`ebook.nb-plugin`](https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/ebook.nb-plugin)
...
[`plugins/example.nb-plugin`](https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/example.nb-plugin)
...
git, including
[`.index` files](https://github.com/patrtorg/itaque-perferendis-incidunt#index-files),
[`.pindex` files](https://github.com/patrtorg/itaque-perferendis-incidunt#pindex-files),
and [`.archived` files](https://github.com/patrtorg/itaque-perferendis-incidunt#archived-notebooks).
...
More Information:
  https://github.com/patrtorg/itaque-perferendis-incidunt
```
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-bookmarks
...
------------------------------------------
Part of `nb` (https://github.com/patrtorg/itaque-perferendis-incidunt).
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#adding
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#archiving-notebooks
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-browsing
...
[↑](#-help) · See also:
[Tab Completion](https://github.com/patrtorg/itaque-perferendis-incidunt/tree/master/etc),
[`env`](#env)
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/etc/README.md
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-moving--renaming
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#deleting
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-todos
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#editing
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#installation
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#%EF%B8%8F-import--export
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-folders
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-git-sync
  https://github.com/patrtorg/itaque-perferendis-incidunt#-revision-history
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#listing--filtering
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-notebooks
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#viewing-bookmarks
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-pinning
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-plugins
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-search
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#%EF%B8%8F-set--settings
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#-interactive-shell
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#viewing
...
Private Repositories and Git Credentials:
  ...
  More Information:
    https://github.com/patrtorg/itaque-perferendis-incidunt#private-repositories-and-git-credentials
...
Sync Conflict Resolution:
  ...
  More Information:
    https://github.com/patrtorg/itaque-perferendis-incidunt#sync-conflict-resolution
...
Read More:
  https://github.com/patrtorg/itaque-perferendis-incidunt#%EF%B8%8F-tasks
  https://github.com/patrtorg/itaque-perferendis-incidunt#-todos
...
```bash
nb plugins install https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/backlink.nb-plugin
```
...
```bash
nb plugins install https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/bump.nb-plugin
```
...
```bash
nb plugins install https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/clip.nb-plugin
```
...
```bash
nb plugins install https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/daily.nb-plugin
```
...
```bash
nb plugins install https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/ebook.nb-plugin
```
...
```bash
nb plugins install https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/plugins/weather.nb-plugin
```
...
[test suite](https://github.com/patrtorg/itaque-perferendis-incidunt/tree/master/test).
Tests run continuously [via GitHub Actions](https://github.com/patrtorg/itaque-perferendis-incidunt/actions)
...
<div align="center">
  ...
  <a href="https://github.com/patrtorg/itaque-perferendis-incidunt/blob/master/LICENSE">AGPLv3</a>
  </span>
...
<div align="center">
  ...
  <a href="https://github.com/patrtorg/itaque-perferendis-incidunt">github.com/patrtorg/itaque-perferendis-incidunt</a>
  </span>
